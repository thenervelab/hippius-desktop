...
#[tauri::command]
pub async fn get_user_credits(state: tauri::State<'_, crate::app_state::AppState>, account_id: crate::app_state::SessionAccount) -> Result<CreditBalance, AppError> {
...
#[tauri::command]
pub async fn check_sync_eligibility(state: tauri::State<'_, crate::app_state::AppState>, account_id: crate::app_state::SessionAccount) -> Result<SyncEligibility, AppError> {
