...
import SyncStatusHandler2 from "./SyncStatusHandler2";
...
const SyncWidgetPlayground2: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-end gap-2">
      <div className="bg-grey-100 border border-grey-80 shadow-menu rounded-md px-3 py-2 flex items-center gap-2">
        ...
        <select
          ...
          className="text-xs bg-grey-95 border border-grey-80 rounded px-2 py-1 text-grey-10 focus:outline-none focus:ring-1 focus:ring-primary-50"
        >
...
export default SyncWidgetPlayground2;
