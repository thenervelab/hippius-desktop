...
export interface UseBridgeReturn {
    ...
    // Operations
    bridgeAlphaToHAlpha: (params: { amount: bigint; mnemonic: string; hotkey?: string }) => Promise<BridgeResult>;
    bridgeHAlphaToAlpha: (params: { amount: bigint; mnemonic: string }) => Promise<BridgeResult>;
