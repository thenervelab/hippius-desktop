...
export const BRIDGE_CONFIG = {
    ...
    bittensor: {
        wsUrl: process.env.NEXT_PUBLIC_BITTENSOR_WS_URL || 'wss://test.finney.opentensor.ai:443',
    ...
    contract: {
        ...
        address: process.env.NEXT_PUBLIC_BRIDGE_CONTRACT_ADDRESS || '5ChKsmrvxKrcqnUWrnZx3er7arFCJdrpETKxhfgXKdQYdjga',
    },

    // Default validator configuration for bridging
    // These can be overridden by user selection in the UI
    defaultValidator: {
        hotkey: process.env.NEXT_PUBLIC_BRIDGE_VALIDATOR_HOTKEY || '5HEiGxfQxEkPWjNCcFT9HTX7cfPi2kKEekxUGDmaFWGRJEFD',
        netuid: parseInt(process.env.NEXT_PUBLIC_BRIDGE_NETUID || '75', 10),
    },
...
export function formatBridgeAmount(amount: bigint, decimals: number): string {
