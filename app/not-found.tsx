          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="flex flex-col items-center justify-center relative">
              ...
              <h1
                ...
                style={{
                  WebkitTextStrokeWidth: (isTablet || isLaptop || isDesktop || isLargeDesktop) ? "6px" : "3px",
                ...
                <div className="max-w-md">
                  ...
                  <RevealTextLine rotate reveal={inView}>
                    <P className="mt-2 text-grey-60 text-center">
                      Hm, that URL doesn’t seem to exist. Try going back home or using the nav to find what you need.
                    </P>
                  </RevealTextLine>
                  ...
                  {/* back home button */}
                  <div 
                    className={cn("bg-primary-50 p-1 border border-primary-40 rounded max-w-[166px] hover:bg-primary-40 opacity-0 translate-y-7 duration-300 delay-300",
                      inView && "opacity-100 translate-y-0"
                    )}
                  >
                    <Link href="/" passHref className="flex justify-center items-center w-full px-4 py-2 bg-primary-50 gap-2 border border-primary-40 text-sm font-medium rounded text-white hover:bg-primary-40">
                      Go Back Home<Icons.ArrowRight className="size-4" />
                    </Link>
                  </div>
                </div>
              </div>
