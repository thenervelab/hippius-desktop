      ...
      {status && (
        <div className="mb-6">
          <div className="flex items-center gap-2">
            <div className={`w-3 h-3 rounded-full ${status.has_interface ? 'bg-green-500 animate-pulse' : 'bg-gray-400'}`}></div>
        ...
        {stats && status?.has_interface ? (
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded border border-blue-100 dark:border-blue-800">
              <div className="text-xs text-blue-500 dark:text-blue-400 font-bold mb-1">TX (Sent)</div>
            ...
            <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded border border-green-100 dark:border-green-800">
              <div className="text-xs text-green-500 dark:text-green-400 font-bold mb-1">RX (Received)</div>
          ...
          <div className="text-gray-500 italic">
            {status?.is_running ? "Waiting for interface..." : "Nebula not running"}
          </div>
        )}
      </div>
