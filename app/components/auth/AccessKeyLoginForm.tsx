                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    <div>
                        ...
                        <p className="text-sm font-medium text-grey-70">
                            Please enter your access key to confirm and start creating your account
                        </p>
                    </div>
                    ...
                    <ButtonCard
                        ...
                        disabled={logginIn}
                        icon={logginIn ? <Loader2 className="size-4 animate-spin text-white" /> : <ArrowRight2 className="size-4" />}
                    >
