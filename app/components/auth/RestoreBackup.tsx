    ...
    <InView triggerOnce>
      {({ inView, ref }) => (
        ...
        >
          ...
          <main
            className="xl:px-[120px] px-[40px] py-10
           items-center justify-between relative h-full w-full grid grid-cols-2 gap-[40px] xl:gap-[120px]"
          >
            <div className="flex flex-col items-start justify-start h-full py-6">
              <RevealTextLine rotate reveal={inView}>
                <div className="flex items-center relative justify-center size-8 bg-primary-50 rounded text-grey-100 xl:mb-28 mb-6">
