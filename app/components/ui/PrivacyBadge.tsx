        ...
        <Tooltip.Provider delayDuration={200}>
            <Tooltip.Root>
                <Tooltip.Trigger asChild>
                    <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-primary-95 border border-primary-80 cursor-default shrink-0">
                        <Icons.ShieldSecurity className="size-3.5 text-primary-50" />
                        <span className="text-[0.6875rem] leading-none font-medium text-primary-50">
                            Private
                        </span>
                    </span>
                </Tooltip.Trigger>
                <Tooltip.Portal>
                    <Tooltip.Content
                        ...
                        align="center"
                        sideOffset={6}
                        className="z-[9999] max-w-[15rem] bg-white border border-grey-80 rounded-lg px-3 py-2 text-xs text-grey-40 shadow-lg animate-in fade-in-0 zoom-in-95"
                    >
