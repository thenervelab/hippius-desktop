...
const APIKeyImportantWarnings: React.FC<ImportantWarningsProps> = ({
    inView = true,
    className = "",
    customWarnings
}) => {
    ...
    const defaultWarnings = [
        {
            id: 1,
            text: `Store this seed in a secure password manager`
        },
        {
            id: 2,
        ...
        },
        {
            ...
            text: (
                <div>
                    Optionally store your seed in an <b>encrypted</b> format within the app
                </div>
            )
        }
    ];
...
export default APIKeyImportantWarnings;
