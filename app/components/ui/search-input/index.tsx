  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="w-full sm:min-w-[229px] h-9 font-medium font-grotesk pl-8 pr-3 py-2 text-sm text-grey-40 placeholder-grey-70 border border-grey-80 rounded focus:outline-none focus:ring-1 focus:ring-grey-70 focus:border-grey-70 hover:border-grey-70 transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
      />
    </div>
  );
};
