          ...
          <div className="flex flex-col gap-0.5">
            ...
            {isStakingLoading ? (
              <div className="flex items-center gap-1">
                ...
                <span className="text-[12px] font-medium text-grey-10 dark:text-white">Loading...</span>
              </div>
            ) : (
              <p className="text-[12px] font-bold leading-[18px] tracking-[-0.36px] text-primary-50 dark:text-primary-brand-dark">
                ...
                <span className="text-[12px] font-medium text-grey-10 dark:text-white"> staked</span>
              </p>
            )}
          </div>
          <Button
