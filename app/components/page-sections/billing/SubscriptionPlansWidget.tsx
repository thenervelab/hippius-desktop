            ...
            >
              ...
              <DropdownMenu.Portal>
                <DropdownMenu.Content
                  className="min-w-[180px] bg-grey-100 rounded shadow-lg p-1 border border-grey-80"
                  sideOffset={5}
                  align="end"
                >
                  <DropdownMenu.Item
      ...
      <div className="relative bg-grey-100 w-full border-grey-80 border-t">
        {isOnHighestPlan ? (
          <div className="flex flex-col items-center justify-center gap-1 pt-4">
            <Typography.P
              size="sm"
              className="text-grey-20 font-medium text-center"
            >
              You&apos;re on our top-tier plan 🎉
            </Typography.P>
            <Typography.P size="xs" className="text-grey-60 text-center">
