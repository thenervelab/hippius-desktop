...
const VPNSettings: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const loadStatus = async () => {
            try {
                const status = await invoke<AutoconnectStatus>("get_autoconnect_status");
    ...
    const handleSave = async (e?: React.FormEvent) => {
        ...
        setSaving(true);
        try {
            const newStatus = await invoke<AutoconnectStatus>("toggle_autoconnect_status");
                                        ...
                                        >
                                            <div
                                                className={cn(
                                                    ...
                                                    autoconnectEnabled ? "translate-x-[22px]" : "translate-x-[2px]"
                                                )}
                                            >
                                                {autoconnectEnabled && (
