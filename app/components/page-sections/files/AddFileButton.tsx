  ...
  ({ className, disabled: externalDisabled, defaultFolderLabel }, ref) => {
    ...
    return (
      <>
        ...
        >
          <Dialog.Portal>
            <Dialog.Overlay className="bg-grey-100/60 fixed p-4 z-30 top-0 w-full h-full flex items-center justify-center data-[state=open]:animate-fade-in-0.3">
              <Dialog.Content className="border shadow-dialog bg-grey-100 flex flex-col max-w-[428px] border-grey-80 bg-background-1 rounded-[8px] overflow-hidden w-full relative data-[state=open]:animate-scale-in-95-0.2">
