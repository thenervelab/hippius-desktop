...
const UploadStatusWidget: React.FC = () => {
    ...
    return (
        <div
            className={cn(
                "fixed flex w-[300px] max-w-[270px] gap-x-2 shadow-dialog z-40 bottom-16 right-4 bg-grey-100 border border-grey-80 rounded-[8px] p-3.5 translate-y-32 duration-500 opacity-0",
