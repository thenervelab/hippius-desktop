...
export interface DeleteAllFilesConfirmationProps {
    open: boolean;
    onClose: () => void;
    onConfirm: () => void;
    loading?: boolean;
...
const DeleteAllFilesConfirmationDialog: React.FC<DeleteAllFilesConfirmationProps> = ({
    open,
    onClose,
    onConfirm,
    loading = false,
    ...
    const scopeDisplay = scope.charAt(0).toUpperCase() + scope.slice(1).toLowerCase();

    return (
        <Dialog.Root open={open} onOpenChange={(isOpen) => !isOpen && onClose()}>
            <DialogContainer className="md:inset-0 md:m-auto md:w-[90vw] md:max-w-[428px] h-fit">
                <Dialog.Title className="sr-only">Delete All {scopeDisplay} Files</Dialog.Title>
                ...
                <div className="px-4">
                    ...
                    <div className="text-2xl font-medium text-grey-10 hidden md:flex flex-col items-center justify-center pb-2 pt-4 gap-4">
                        ...
                        <span className="text-center text-2xl text-grey-10 font-medium">
                            Delete all {scopeDisplay.toLowerCase()} files?
                        </span>
                    </div>
                    ...
                    <div className="flex py-4 items-center justify-between text-grey-10 relative w-full md:hidden">
                        ...
                        <div className="text-lg font-medium relative">
                            <span className="capitalize">Delete All {scopeDisplay} Files</span>
                        </div>
                    ...
                    <div className="font-medium text-base text-grey-20 mb-4 text-center">
                        This will permanently remove all {scopeDisplay.toLowerCase()} files from your storage.
...
export default DeleteAllFilesConfirmationDialog;
