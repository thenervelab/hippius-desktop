    ...
    <div className={cn("space-y-3", className)}>
      <div className="flex items-center justify-between">
        ...
        <div className="relative group">
          <input
            ...
            placeholder="0"
            className="w-[11.25rem] h-12 font-medium font-grotesk pl-3 pr-16 py-3 text-base text-grey-60 placeholder-grey-70 border border-grey-80 rounded-xl focus:outline-none focus:ring-1 focus:ring-gray-300 focus:border-gray-300 hover:border-grey-70 transition-colors"
          />
          <div className="absolute right-0 top-1/2  h-full">
            <Menubar.Root>
              <Menubar.Menu>
                ...
                <Menubar.Content className="mt-1 bg-white border border-grey-80 rounded-lg p-1 shadow-menu min-w-[5rem] z-50">
                  <UnitMenuItem
                    unit="KB"
      ...
      <div className="mt-3">
        ...
        >
          ...
          <SliderPrimitive.Thumb className="block h-[1rem] w-[1rem] rounded-full border border-primary-50 bg-primary-50 shadow-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary-50 focus-visible:ring-offset-1 disabled:pointer-events-none disabled:opacity-50" />
        </SliderPrimitive.Root>
      </div>
    </div>
  );
