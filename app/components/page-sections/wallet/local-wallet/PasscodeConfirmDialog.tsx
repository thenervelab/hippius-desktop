...
const PasscodeConfirmDialog: React.FC<PasscodeConfirmDialogProps> = ({
  open,
  onClose,
  onConfirm,
  title = "Confirm Transaction",
  description = "Enter your passcode to sign and submit this transaction",
  ...
  }, [passcode, unlockWallet, onConfirm, resetState]);
