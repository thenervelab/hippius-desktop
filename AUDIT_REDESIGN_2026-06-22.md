...
- **Remaining workstream:** the **bridge → Rust port** (H) — a large, testnet-gated rewrite (new subxt metadata codegen, `parity-scale-codec`, hand-rolled ink! contract calls, deletion of the whole TS bridge). Its on-chain write paths require a funded Bittensor/Hippius testnet wallet to verify.
