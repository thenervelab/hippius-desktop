...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<Idl4dgic8j220i>, false, never>;
        /**
    ...
    Proxy: {
         ...
         */
        LastCallResult: StorageDescriptor<[Key: SS58String], Anonymize<I9dkdd0svp2anm>, true, never>;
    };
    Registry: {
        /**
    ...
    Swap: {
         ...
         */
        SwapBalancer: StorageDescriptor<[Key: number], bigint, false, never>;
        /**
         * Storage to determine whether balancer swap was initialized for a specific subnet.
         */
        PalSwapInitialized: StorageDescriptor<[Key: number], boolean, false, never>;
        /**
         * Total fees in TAO per subnet due to be paid to users / protocol
         */
        FeesTao: StorageDescriptor<[Key: number], bigint, false, never>;
        /**
         * Total fees in Alpha per subnet due to be paid to users / protocol
         */
        FeesAlpha: StorageDescriptor<[Key: number], bigint, false, never>;
        /**
         * --- Storage for migration run status
         */
        HasMigrationRun: StorageDescriptor<[Key: Binary], boolean, false, never>;
...
type ICalls = {
    ...
    Utility: {
         ...
         * event is deposited.
         */
        batch: TxDescriptor<Anonymize<I8dv6qj04g67f6>>;
        /**
         ...
         */
        as_derivative: TxDescriptor<Anonymize<Idrqhfmcqj6s9k>>;
        /**
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<I8dv6qj04g67f6>>;
        /**
         ...
         * - O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<I4o3j3biuetmn6>>;
        /**
         * Send a batch of dispatch calls.
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<I8dv6qj04g67f6>>;
        /**
         ...
         * The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<I77jh18qf00h3j>>;
        /**
         ...
         * or both.
         */
        if_else: TxDescriptor<Anonymize<Idtnqq2a4jl0f4>>;
        /**
         * Dispatches a function call with a provided origin.
         *
         ...
         * The dispatch origin for this call must be _Root_.
         */
        dispatch_as_fallible: TxDescriptor<Anonymize<I4o3j3biuetmn6>>;
    };
    Sudo: {
        /**
         * Authenticates the sudo key and dispatches a function call with `Root` origin.
         */
        sudo: TxDescriptor<Anonymize<I1kq857mo69eu7>>;
        /**
         * Authenticates the sudo key and dispatches a function call with `Root` origin.
         * This function does not check the weight of the call, and instead allows the
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        sudo_unchecked_weight: TxDescriptor<Anonymize<I77jh18qf00h3j>>;
        /**
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        sudo_as: TxDescriptor<Anonymize<Icoe7opmtd7qe1>>;
        /**
    ...
    Multisig: {
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<I3rt0lr178u9f2>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<I83718vol4v4pm>>;
        /**
         * Register approval for a dispatch to be made from a deterministic composite account if
         * approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Scheduler: {
         ...
         */
        schedule: TxDescriptor<Anonymize<I12j3closeroc0>>;
        /**
         ...
         */
        schedule_named: TxDescriptor<Anonymize<Ieg42qkecnn5c3>>;
        /**
         ...
         */
        schedule_after: TxDescriptor<Anonymize<I21v9poe6i1enr>>;
        /**
         * Schedule a named task after a delay.
         */
        schedule_named_after: TxDescriptor<Anonymize<Id66b1tvo5iht7>>;
        /**
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<I42l0e1oijb6bn>>;
        /**
         ...
         * - `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<I8o7hg9oj4hscp>>;
        /**
    ...
    Crowdloan: {
         ...
         */
        create: TxDescriptor<Anonymize<Ichahh9gh3g4i>>;
        /**
...
type IEvent = {
    System: {
         ...
         * An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<I6jv8i738ud2so>>;
        /**
         * `:code` was updated.
         */
         ...
         */
        RejectedInvalidAuthorizedUpgrade: PlainDescriptor<Anonymize<I4n7lnouhqs6pg>>;
    };
    Grandpa: {
        /**
    ...
    SubtensorModule: {
         ...
         * a sudo call is done.
         */
        Sudid: PlainDescriptor<Anonymize<I9dkdd0svp2anm>>;
        /**
         ...
         */
        BatchWeightItemFailed: PlainDescriptor<Anonymize<I6orop8m3bqhqc>>;
        /**
    ...
    Utility: {
         ...
         * well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<I5vqj6vsa4qso8>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<I6s1s5tibubgjg>>;
        /**
         * A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<I2b5odcspaigh3>>;
        /**
         ...
         */
        IfElseFallbackCalled: PlainDescriptor<Anonymize<I6e6r73jpum7ks>>;
    };
    Sudo: {
        /**
         * A sudo call just took place.
         */
        Sudid: PlainDescriptor<Anonymize<Ic5uv6hvtb4vnp>>;
        /**
         ...
         */
        SudoAsDone: PlainDescriptor<Anonymize<Ic5uv6hvtb4vnp>>;
    };
    Multisig: {
        /**
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<Ie5vlr9k5tqqtn>>;
        /**
    ...
    Scheduler: {
         ...
         */
        Dispatched: PlainDescriptor<Anonymize<Ifdpmem946rhur>>;
        /**
    ...
    Proxy: {
         ...
         */
        ProxyExecuted: PlainDescriptor<Anonymize<I2b5odcspaigh3>>;
        /**
    ...
    MevShield: {
         ...
         */
        DecryptedRejected: PlainDescriptor<Anonymize<I9a8thrj9sk1ua>>;
        /**
...
type IError = {
    ...
    Swap: {
         ...
         */
        ReservesOutOfBalance: PlainDescriptor<undefined>;
        /**
...
type IViewFns = {
    Proxy: {
         ...
         */
        check_permissions: RuntimeDescriptor<[call: Anonymize<I4v2u7504g53eo>, proxy_type: Anonymize<I8v1041j74kmaj>], boolean>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<I2478jmjgv26ib>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<I4v2u7504g53eo>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<I4v2u7504g53eo>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    EthereumRuntimeRPCApi: {
         ...
         */
        call: RuntimeDescriptor<[from: FixedSizeBinary<20>, to: FixedSizeBinary<20>, data: Binary, value: Anonymize<I4totqt881mlti>, gas_limit: Anonymize<I4totqt881mlti>, max_fee_per_gas: Anonymize<Ic4rgfgksgmm3e>, max_priority_fee_per_gas: Anonymize<Ic4rgfgksgmm3e>, nonce: Anonymize<Ic4rgfgksgmm3e>, estimate: boolean, access_list: Anonymize<I3dj14b7k3rkm5>, authorization_list: Anonymize<Ic5egmm215ml6k>], Anonymize<Isie6rb08fgbf>>;
        /**
        
         */
        create: RuntimeDescriptor<[from: FixedSizeBinary<20>, data: Binary, value: Anonymize<I4totqt881mlti>, gas_limit: Anonymize<I4totqt881mlti>, max_fee_per_gas: Anonymize<Ic4rgfgksgmm3e>, max_priority_fee_per_gas: Anonymize<Ic4rgfgksgmm3e>, nonce: Anonymize<Ic4rgfgksgmm3e>, estimate: boolean, access_list: Anonymize<I3dj14b7k3rkm5>, authorization_list: Anonymize<Ic5egmm215ml6k>], Anonymize<Inotr0scdlvht>>;
        /**
    ...
    ContractsApi: {
         ...
         */
        call: RuntimeDescriptor<[origin: SS58String, dest: SS58String, value: bigint, gas_limit: Anonymize<Iasb8k6ash5mjn>, storage_deposit_limit: Anonymize<I35p85j063s0il>, input_data: Binary], Anonymize<Ickqvsc42g7jaj>>;
        /**
         * Instantiate a new contract.
         *
         * See `[crate::Pallet::bare_instantiate]`.
         */
        instantiate: RuntimeDescriptor<[origin: SS58String, value: bigint, gas_limit: Anonymize<Iasb8k6ash5mjn>, storage_deposit_limit: Anonymize<I35p85j063s0il>, code: Anonymize<I9sijb8gfrns29>, data: Binary, salt: Binary], Anonymize<I62367b4vvbr1u>>;
        /**
         * Upload new code without instantiating a contract from it.
         *
         * See [`crate::Pallet::bare_upload_code`].
         */
        upload_code: RuntimeDescriptor<[origin: SS58String, code: Binary, storage_deposit_limit: Anonymize<I35p85j063s0il>, determinism: Anonymize<I2dfliekq1ed7e>], Anonymize<I95an1md3ghn7t>>;
        /**
...
export type BittensorDispatchError = Anonymize<I6orop8m3bqhqc>;
type IAsset = PlainDescriptor<void>;
export type BittensorExtensions = {};
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type Bittensor = {
    ...
    asset: IAsset;
    extensions: BittensorExtensions;
    getMetadata: () => Promise<Uint8Array>;
    genesis: string | undefined;
};
declare const _allDescriptors: Bittensor;
export default _allDescriptors;
export type BittensorApis = ApisFromDef<IRuntimeCalls>;
export type BittensorQueries = QueryFromPalletsDef<PalletsTypedef>;
export type BittensorCalls = TxFromPalletsDef<PalletsTypedef>;
export type BittensorEvents = EventsFromPalletsDef<PalletsTypedef>;
export type BittensorErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type BittensorConstants = ConstFromPalletsDef<PalletsTypedef>;
export type BittensorViewFns = ViewFnsFromPalletsDef<PalletsTypedef>;
export type BittensorCallData = Anonymize<I4v2u7504g53eo> & {
    value: {
        type: string;
    };
};
type AllInteractions = {
    storage: {
        ...
        SubtensorModule: ['MinActivityCutoff', 'AdminFreezeWindow', 'OwnerHyperparamRateLimit', 'DissolveNetworkScheduleDuration', 'LastHotkeySwapOnNetuid', 'NextStakeJobId', 'TaoWeight', 'CKBurn', 'MaxDelegateTake', 'MinDelegateTake', 'MaxChildkeyTake', 'MinChildkeyTake', 'Owner', 'Delegates', 'ChildkeyTake', 'PendingChildKeys', 'ChildKeys', 'ParentKeys', 'AlphaDividendsPerSubnet', 'RootAlphaDividendsPerSubnet', 'BlockEmission', 'LastHotkeyEmissionOnNetuid', 'SubnetLimit', 'TotalIssuance', 'TotalStake', 'SubnetMovingAlpha', 'SubnetMovingPrice', 'RootProp', 'SubnetVolume', 'SubnetTAO', 'SubnetAlphaInEmission', 'SubnetAlphaOutEmission', 'SubnetTaoInEmission', 'SubnetAlphaIn', 'SubnetAlphaOut', 'StakingHotkeys', 'OwnedHotkeys', 'AutoStakeDestination', 'AutoStakeDestinationColdkeys', 'ColdkeySwapAnnouncementDelay', 'ColdkeySwapReannouncementDelay', 'ColdkeySwapAnnouncements', 'ColdkeySwapDisputes', 'TotalHotkeyAlpha', 'TotalHotkeyAlphaLastEpoch', 'TotalHotkeyShares', 'Alpha', 'AlphaMapLastKey', 'TokenSymbol', 'SubnetTaoFlow', 'SubnetEmaTaoFlow', 'TaoFlowCutoff', 'FlowNormExponent', 'FlowEmaSmoothingFactor', 'UsedWork', 'MaxRegistrationsPerBlock', 'TotalNetworks', 'NetworkImmunityPeriod', 'StartCallDelay', 'NetworkMinLockCost', 'NetworkLastLockCost', 'NetworkLockReductionInterval', 'SubnetOwnerCut', 'NetworkRateLimit', 'NominatorMinRequiredStake', 'WeightsVersionKeyRateLimit', 'LastRateLimitedBlock', 'TransferToggle', 'SubnetLocked', 'LargestLocked', 'Tempo', 'FirstEmissionBlockNumber', 'SubnetMechanism', 'SubnetworkN', 'NetworksAdded', 'IsNetworkMember', 'NetworkRegistrationAllowed', 'NetworkPowRegistrationAllowed', 'NetworkRegisteredAt', 'PendingServerEmission', 'PendingValidatorEmission', 'PendingRootAlphaDivs', 'PendingOwnerCut', 'BlocksSinceLastStep', 'LastMechansimStepBlock', 'SubnetOwner', 'SubnetOwnerHotkey', 'RecycleOrBurn', 'ServingRateLimit', 'Rho', 'AlphaSigmoidSteepness', 'Kappa', 'RegistrationsThisInterval', 'POWRegistrationsThisInterval', 'BurnRegistrationsThisInterval', 'MinAllowedUids', 'MaxAllowedUids', 'ImmunityPeriod', 'ActivityCutoff', 'MaxWeightsLimit', 'WeightsVersionKey', 'MinAllowedWeights', 'MaxAllowedValidators', 'AdjustmentInterval', 'BondsMovingAverage', 'BondsPenalty', 'BondsResetOn', 'WeightsSetRateLimit', 'ValidatorPruneLen', 'ScalingLawPower', 'TargetRegistrationsPerInterval', 'AdjustmentAlpha', 'CommitRevealWeightsEnabled', 'Burn', 'Difficulty', 'MinBurn', 'MaxBurn', 'MinDifficulty', 'MaxDifficulty', 'LastAdjustmentBlock', 'RegistrationsThisBlock', 'EMAPriceHalvingBlocks', 'RAORecycledForRegistration', 'TxRateLimit', 'TxDelegateTakeRateLimit', 'TxChildkeyTakeRateLimit', 'LiquidAlphaOn', 'Yuma3On', 'AlphaValues', 'SubtokenEnabled', 'VotingPower', 'VotingPowerTrackingEnabled', 'VotingPowerDisableAtBlock', 'VotingPowerEmaAlpha', 'ImmuneOwnerUidsLimit', 'StakeWeight', 'Uids', 'Keys', 'LoadedEmission', 'Active', 'Rank', 'Trust', 'Consensus', 'Incentive', 'Dividends', 'Emission', 'LastUpdate', 'ValidatorTrust', 'PruningScores', 'ValidatorPermit', 'Weights', 'Bonds', 'BlockAtRegistration', 'Axons', 'NeuronCertificates', 'Prometheus', 'IdentitiesV2', 'SubnetIdentitiesV3', 'TransactionKeyLastBlock', 'LastTxBlock', 'LastTxBlockChildKeyTake', 'LastTxBlockDelegateTake', 'StakeThreshold', 'WeightCommits', 'TimelockedWeightCommits', 'CRV3WeightCommits', 'CRV3WeightCommitsV2', 'RevealPeriodEpochs', 'LastColdkeyHotkeyStakeBlock', 'StakingOperationRateLimiter', 'RootClaimableThreshold', 'RootClaimable', 'RootClaimed', 'RootClaimType', 'StakingColdkeysByIndex', 'StakingColdkeys', 'NumStakingColdkeys', 'NumRootClaim', 'AssociatedEvmAddress', 'SubnetLeases', 'SubnetLeaseShares', 'SubnetUidToLeaseId', 'NextSubnetLeaseId', 'AccumulatedLeaseDividends', 'CommitRevealWeightsVersion', 'NetworkRegistrationStartBlock', 'MinNonImmuneUids', 'MaxMechanismCount', 'MechanismCountCurrent', 'MechanismEmissionSplit', 'HasMigrationRun', 'PendingChildKeyCooldown'];
        Sudo: ['Key'];
        Multisig: ['Multisigs'];
        Preimage: ['StatusFor', 'RequestStatusFor', 'PreimageFor'];
        Scheduler: ['IncompleteSince', 'Agenda', 'Retries', 'Lookup'];
        Proxy: ['Proxies', 'Announcements', 'LastCallResult'];
        Registry: ['IdentityOf'];
        Commitments: ['TimelockedIndex', 'CommitmentOf', 'LastCommitment', 'LastBondsReset', 'RevealedCommitments', 'UsedSpaceOf', 'MaxSpace'];
        AdminUtils: ['PrecompileEnable'];
        SafeMode: ['EnteredUntil', 'Deposits'];
        Ethereum: ['Pending', 'CounterForPending', 'CurrentBlock', 'CurrentReceipts', 'CurrentTransactionStatuses', 'BlockHash'];
        EVM: ['AccountCodes', 'AccountCodesMetadata', 'AccountStorages', 'WhitelistedCreators', 'DisableWhitelistCheck'];
        EVMChainId: ['ChainId'];
        BaseFee: ['BaseFeePerGas', 'Elasticity'];
        Drand: ['BeaconConfig', 'HasMigrationRun', 'Pulses', 'LastStoredRound', 'OldestStoredRound', 'NextUnsignedAt'];
        Crowdloan: ['Crowdloans', 'NextCrowdloanId', 'Contributions', 'CurrentCrowdloanId', 'HasMigrationRun'];
        Swap: ['FeeRate', 'SwapBalancer', 'PalSwapInitialized', 'FeesTao', 'FeesAlpha', 'HasMigrationRun'];
        Contracts: ['PristineCode', 'CodeInfoOf', 'Nonce', 'ContractInfoOf', 'DeletionQueue', 'DeletionQueueCounter', 'MigrationInProgress'];
        MevShield: ['CurrentKey', 'NextKey', 'Submissions', 'KeyHashByBlock'];
    };
    tx: {
        ...
        SubtensorModule: ['set_weights', 'set_mechanism_weights', 'batch_set_weights', 'commit_weights', 'commit_mechanism_weights', 'batch_commit_weights', 'reveal_weights', 'reveal_mechanism_weights', 'commit_crv3_mechanism_weights', 'batch_reveal_weights', 'decrease_take', 'increase_take', 'add_stake', 'remove_stake', 'serve_axon', 'serve_axon_tls', 'serve_prometheus', 'register', 'root_register', 'burned_register', 'swap_hotkey', 'swap_coldkey', 'set_childkey_take', 'sudo_set_tx_childkey_take_rate_limit', 'sudo_set_min_childkey_take', 'sudo_set_max_childkey_take', 'register_network', 'dissolve_network', 'set_children', 'schedule_swap_coldkey', 'set_identity', 'set_subnet_identity', 'register_network_with_identity', 'unstake_all', 'unstake_all_alpha', 'move_stake', 'transfer_stake', 'swap_stake', 'add_stake_limit', 'remove_stake_limit', 'swap_stake_limit', 'try_associate_hotkey', 'start_call', 'associate_evm_key', 'recycle_alpha', 'burn_alpha', 'set_pending_childkey_cooldown', 'remove_stake_full_limit', 'register_leased_network', 'terminate_lease', 'update_symbol', 'commit_timelocked_weights', 'set_coldkey_auto_stake_hotkey', 'commit_timelocked_mechanism_weights', 'root_dissolve_network', 'claim_root', 'set_root_claim_type', 'sudo_set_num_root_claims', 'sudo_set_root_claim_threshold', 'announce_coldkey_swap', 'swap_coldkey_announced', 'dispute_coldkey_swap', 'reset_coldkey_swap', 'enable_voting_power_tracking', 'disable_voting_power_tracking', 'sudo_set_voting_power_ema_alpha', 'add_stake_burn'];
        ...
        Registry: ['set_identity', 'clear_identity'];
        Commitments: ['set_commitment', 'set_max_space'];
        AdminUtils: ['swap_authorities', 'sudo_set_default_take', 'sudo_set_tx_rate_limit', 'sudo_set_serving_rate_limit', 'sudo_set_min_difficulty', 'sudo_set_max_difficulty', 'sudo_set_weights_version_key', 'sudo_set_weights_set_rate_limit', 'sudo_set_adjustment_interval', 'sudo_set_adjustment_alpha', 'sudo_set_immunity_period', 'sudo_set_min_allowed_weights', 'sudo_set_max_allowed_uids', 'sudo_set_kappa', 'sudo_set_rho', 'sudo_set_activity_cutoff', 'sudo_set_network_registration_allowed', 'sudo_set_network_pow_registration_allowed', 'sudo_set_target_registrations_per_interval', 'sudo_set_min_burn', 'sudo_set_max_burn', 'sudo_set_difficulty', 'sudo_set_max_allowed_validators', 'sudo_set_bonds_moving_average', 'sudo_set_bonds_penalty', 'sudo_set_max_registrations_per_block', 'sudo_set_subnet_owner_cut', 'sudo_set_network_rate_limit', 'sudo_set_tempo', 'sudo_set_total_issuance', 'sudo_set_network_immunity_period', 'sudo_set_network_min_lock_cost', 'sudo_set_subnet_limit', 'sudo_set_lock_reduction_interval', 'sudo_set_rao_recycled', 'sudo_set_stake_threshold', 'sudo_set_nominator_min_required_stake', 'sudo_set_tx_delegate_take_rate_limit', 'sudo_set_min_delegate_take', 'sudo_set_commit_reveal_weights_enabled', 'sudo_set_liquid_alpha_enabled', 'sudo_set_alpha_values', 'sudo_set_dissolve_network_schedule_duration', 'sudo_set_commit_reveal_weights_interval', 'sudo_set_evm_chain_id', 'schedule_grandpa_change', 'sudo_set_toggle_transfer', 'sudo_set_recycle_or_burn', 'sudo_toggle_evm_precompile', 'sudo_set_subnet_moving_alpha', 'sudo_set_subnet_owner_hotkey', 'sudo_set_ema_price_halving_period', 'sudo_set_alpha_sigmoid_steepness', 'sudo_set_yuma3_enabled', 'sudo_set_bonds_reset_enabled', 'sudo_set_sn_owner_hotkey', 'sudo_set_subtoken_enabled', 'sudo_set_commit_reveal_version', 'sudo_set_owner_immune_neuron_limit', 'sudo_set_ck_burn', 'sudo_set_admin_freeze_window', 'sudo_set_owner_hparam_rate_limit', 'sudo_set_mechanism_count', 'sudo_set_mechanism_emission_split', 'sudo_trim_to_max_allowed_uids', 'sudo_set_min_allowed_uids', 'sudo_set_tao_flow_cutoff', 'sudo_set_tao_flow_normalization_exponent', 'sudo_set_tao_flow_smoothing_factor', 'sudo_set_max_mechanism_count', 'sudo_set_min_non_immune_uids', 'sudo_set_start_call_delay', 'sudo_set_coldkey_swap_announcement_delay', 'sudo_set_coldkey_swap_reannouncement_delay'];
        SafeMode: ['enter', 'force_enter', 'extend', 'force_extend', 'force_exit', 'force_slash_deposit', 'release_deposit', 'force_release_deposit'];
        Ethereum: ['transact'];
        EVM: ['withdraw', 'call', 'create', 'create2', 'set_whitelist', 'disable_whitelist'];
        BaseFee: ['set_base_fee_per_gas', 'set_elasticity'];
        Drand: ['write_pulse', 'set_beacon_config', 'set_oldest_stored_round'];
        Crowdloan: ['create', 'contribute', 'withdraw', 'finalize', 'refund', 'dissolve', 'update_min_contribution', 'update_end', 'update_cap'];
        Swap: ['set_fee_rate', 'toggle_user_liquidity', 'add_liquidity', 'remove_liquidity', 'modify_position', 'disable_lp'];
        Contracts: ['call_old_weight', 'instantiate_with_code_old_weight', 'instantiate_old_weight', 'upload_code', 'remove_code', 'set_code', 'call', 'instantiate_with_code', 'instantiate', 'migrate'];
        MevShield: ['announce_next_key', 'submit_encrypted', 'mark_decryption_failed'];
    };
    events: {
        ...
        Registry: ['IdentitySet', 'IdentityDissolved'];
        Commitments: ['Commitment', 'TimelockCommitment', 'CommitmentRevealed'];
        AdminUtils: ['PrecompileUpdated', 'Yuma3EnableToggled', 'BondsResetToggled'];
        SafeMode: ['Entered', 'Extended', 'Exited', 'DepositPlaced', 'DepositReleased', 'DepositSlashed', 'CannotDeposit', 'CannotRelease'];
        Ethereum: ['Executed'];
        EVM: ['Log', 'Created', 'CreatedFailed', 'Executed', 'ExecutedFailed'];
        BaseFee: ['NewBaseFeePerGas', 'BaseFeeOverflow', 'NewElasticity'];
        Drand: ['BeaconConfigChanged', 'NewPulse', 'SetOldestStoredRound'];
        Crowdloan: ['Created', 'Contributed', 'Withdrew', 'PartiallyRefunded', 'AllRefunded', 'Finalized', 'Dissolved', 'MinContributionUpdated', 'EndUpdated', 'CapUpdated'];
        Swap: ['FeeRateSet'];
        Contracts: ['Instantiated', 'Terminated', 'CodeStored', 'ContractEmitted', 'CodeRemoved', 'ContractCodeUpdated', 'Called', 'DelegateCalled', 'StorageDepositTransferredAndHeld', 'StorageDepositTransferredAndReleased'];
        MevShield: ['EncryptedSubmitted', 'DecryptedExecuted', 'DecryptedRejected', 'DecryptionFailed'];
    };
    errors: {
        ...
        SubtensorModule: ['RootNetworkDoesNotExist', 'InvalidIpType', 'InvalidIpAddress', 'InvalidPort', 'HotKeyNotRegisteredInSubNet', 'HotKeyAccountNotExists', 'HotKeyNotRegisteredInNetwork', 'NonAssociatedColdKey', 'NotEnoughStake', 'NotEnoughStakeToWithdraw', 'NotEnoughStakeToSetWeights', 'NotEnoughStakeToSetChildkeys', 'NotEnoughBalanceToStake', 'BalanceWithdrawalError', 'ZeroBalanceAfterWithdrawn', 'NeuronNoValidatorPermit', 'WeightVecNotEqualSize', 'DuplicateUids', 'UidVecContainInvalidOne', 'WeightVecLengthIsLow', 'TooManyRegistrationsThisBlock', 'HotKeyAlreadyRegisteredInSubNet', 'NewHotKeyIsSameWithOld', 'InvalidWorkBlock', 'InvalidDifficulty', 'InvalidSeal', 'MaxWeightExceeded', 'HotKeyAlreadyDelegate', 'SettingWeightsTooFast', 'IncorrectWeightVersionKey', 'ServingRateLimitExceeded', 'UidsLengthExceedUidsInSubNet', 'NetworkTxRateLimitExceeded', 'DelegateTxRateLimitExceeded', 'HotKeySetTxRateLimitExceeded', 'StakingRateLimitExceeded', 'SubNetRegistrationDisabled', 'TooManyRegistrationsThisInterval', 'TransactorAccountShouldBeHotKey', 'FaucetDisabled', 'NotSubnetOwner', 'RegistrationNotPermittedOnRootSubnet', 'StakeTooLowForRoot', 'AllNetworksInImmunity', 'NotEnoughBalanceToPaySwapHotKey', 'NotRootSubnet', 'CanNotSetRootNetworkWeights', 'NoNeuronIdAvailable', 'DelegateTakeTooLow', 'DelegateTakeTooHigh', 'NoWeightsCommitFound', 'InvalidRevealCommitHashNotMatch', 'CommitRevealEnabled', 'CommitRevealDisabled', 'LiquidAlphaDisabled', 'AlphaHighTooLow', 'AlphaLowOutOfRange', 'ColdKeyAlreadyAssociated', 'NotEnoughBalanceToPaySwapColdKey', 'InvalidChild', 'DuplicateChild', 'ProportionOverflow', 'TooManyChildren', 'TxRateLimitExceeded', 'ColdkeySwapAnnouncementNotFound', 'ColdkeySwapTooEarly', 'ColdkeySwapReannouncedTooEarly', 'AnnouncedColdkeyHashDoesNotMatch', 'ColdkeySwapAlreadyDisputed', 'NewColdKeyIsHotkey', 'InvalidChildkeyTake', 'TxChildkeyTakeRateLimitExceeded', 'InvalidIdentity', 'MechanismDoesNotExist', 'CannotUnstakeLock', 'SubnetNotExists', 'TooManyUnrevealedCommits', 'ExpiredWeightCommit', 'RevealTooEarly', 'InputLengthsUnequal', 'CommittingWeightsTooFast', 'AmountTooLow', 'InsufficientLiquidity', 'SlippageTooHigh', 'TransferDisallowed', 'ActivityCutoffTooLow', 'CallDisabled', 'FirstEmissionBlockNumberAlreadySet', 'NeedWaitingMoreBlocksToStarCall', 'NotEnoughAlphaOutToRecycle', 'CannotBurnOrRecycleOnRootSubnet', 'UnableToRecoverPublicKey', 'InvalidRecoveredPublicKey', 'SubtokenDisabled', 'HotKeySwapOnSubnetIntervalNotPassed', 'ZeroMaxStakeAmount', 'SameNetuid', 'InsufficientBalance', 'StakingOperationRateLimitExceeded', 'InvalidLeaseBeneficiary', 'LeaseCannotEndInThePast', 'LeaseNetuidNotFound', 'LeaseDoesNotExist', 'LeaseHasNoEndBlock', 'LeaseHasNotEnded', 'Overflow', 'BeneficiaryDoesNotOwnHotkey', 'ExpectedBeneficiaryOrigin', 'AdminActionProhibitedDuringWeightsWindow', 'SymbolDoesNotExist', 'SymbolAlreadyInUse', 'IncorrectCommitRevealVersion', 'RevealPeriodTooLarge', 'RevealPeriodTooSmall', 'InvalidValue', 'SubnetLimitReached', 'CannotAffordLockCost', 'EvmKeyAssociateRateLimitExceeded', 'SameAutoStakeHotkeyAlreadySet', 'UidMapCouldNotBeCleared', 'TrimmingWouldExceedMaxImmunePercentage', 'ChildParentInconsistency', 'InvalidNumRootClaim', 'InvalidRootClaimThreshold', 'InvalidSubnetNumber', 'TooManyUIDsPerMechanism', 'VotingPowerTrackingNotEnabled', 'InvalidVotingPowerEmaAlpha', 'PrecisionLoss', 'Deprecated', 'AddStakeBurnRateLimitExceeded'];
        Utility: ['TooManyCalls', 'InvalidDerivedAccount'];
        Sudo: ['RequireSudo'];
        ...
        Proxy: ['TooMany', 'NotFound', 'NotProxy', 'Unproxyable', 'Duplicate', 'NoPermission', 'Unannounced', 'NoSelfProxy', 'AnnouncementDepositInvariantViolated', 'InvalidDerivedAccountId'];
        Registry: ['CannotRegister', 'TooManyFieldsInIdentityInfo', 'NotRegistered'];
        Commitments: ['TooManyFieldsInCommitmentInfo', 'AccountNotAllowedCommit', 'SpaceLimitExceeded', 'UnexpectedUnreserveLeftover'];
        AdminUtils: ['SubnetDoesNotExist', 'MaxValidatorsLargerThanMaxUIds', 'MaxAllowedUIdsLessThanCurrentUIds', 'BondsMovingAverageMaxReached', 'NegativeSigmoidSteepness', 'ValueNotInBounds', 'MinAllowedUidsGreaterThanCurrentUids', 'MinAllowedUidsGreaterThanMaxAllowedUids', 'MaxAllowedUidsLessThanMinAllowedUids', 'MaxAllowedUidsGreaterThanDefaultMaxAllowedUids', 'InvalidValue'];
        SafeMode: ['Entered', 'Exited', 'NotConfigured', 'NoDeposit', 'AlreadyDeposited', 'CannotReleaseYet', 'CurrencyError'];
        Ethereum: ['InvalidSignature', 'PreLogExists'];
        EVM: ['BalanceLow', 'FeeOverflow', 'PaymentOverflow', 'WithdrawFailed', 'GasPriceTooLow', 'InvalidNonce', 'GasLimitTooLow', 'GasLimitTooHigh', 'InvalidChainId', 'InvalidSignature', 'Reentrancy', 'TransactionMustComeFromEOA', 'Undefined', 'NotAllowed', 'CreateOriginNotAllowed'];
        Drand: ['NoneValue', 'StorageOverflow', 'DrandConnectionFailure', 'UnverifiedPulse', 'InvalidRoundNumber', 'PulseVerificationError'];
        Crowdloan: ['DepositTooLow', 'CapTooLow', 'MinimumContributionTooLow', 'CannotEndInPast', 'BlockDurationTooShort', 'BlockDurationTooLong', 'InsufficientBalance', 'Overflow', 'InvalidCrowdloanId', 'CapRaised', 'ContributionPeriodEnded', 'ContributionTooLow', 'InvalidOrigin', 'AlreadyFinalized', 'ContributionPeriodNotEnded', 'NoContribution', 'CapNotRaised', 'Underflow', 'CallUnavailable', 'NotReadyToDissolve', 'DepositCannotBeWithdrawn', 'MaxContributorsReached'];
        Swap: ['FeeRateTooHigh', 'InsufficientInputAmount', 'InsufficientLiquidity', 'PriceLimitExceeded', 'InsufficientBalance', 'InvalidTickRange', 'InvalidLiquidityValue', 'ReservesTooLow', 'MechanismDoesNotExist', 'SubtokenDisabled', 'ReservesOutOfBalance', 'Deprecated'];
        ...
        MevShield: ['SubmissionAlreadyExists', 'MissingSubmission', 'CommitmentMismatch', 'SignatureInvalid', 'BadPublicKeyLen', 'KeyExpired', 'KeyHashMismatch'];
    };
    constants: {
        ...
        SubtensorModule: ['InitialIssuance', 'InitialMinAllowedWeights', 'InitialEmissionValue', 'InitialTempo', 'InitialDifficulty', 'InitialMaxDifficulty', 'InitialMinDifficulty', 'InitialRAORecycledForRegistration', 'InitialBurn', 'InitialMaxBurn', 'InitialMinBurn', 'MinBurnUpperBound', 'MaxBurnLowerBound', 'InitialAdjustmentInterval', 'InitialBondsMovingAverage', 'InitialBondsPenalty', 'InitialBondsResetOn', 'InitialTargetRegistrationsPerInterval', 'InitialRho', 'InitialAlphaSigmoidSteepness', 'InitialKappa', 'InitialMinAllowedUids', 'InitialMaxAllowedUids', 'InitialValidatorPruneLen', 'InitialScalingLawPower', 'InitialImmunityPeriod', 'InitialActivityCutoff', 'InitialMaxRegistrationsPerBlock', 'InitialPruningScore', 'InitialMaxAllowedValidators', 'InitialDefaultDelegateTake', 'InitialMinDelegateTake', 'InitialDefaultChildKeyTake', 'InitialMinChildKeyTake', 'InitialMaxChildKeyTake', 'InitialWeightsVersionKey', 'InitialServingRateLimit', 'InitialTxRateLimit', 'InitialTxDelegateTakeRateLimit', 'InitialTxChildKeyTakeRateLimit', 'InitialAdjustmentAlpha', 'InitialNetworkImmunityPeriod', 'InitialNetworkMinLockCost', 'InitialSubnetOwnerCut', 'InitialNetworkLockReductionInterval', 'InitialNetworkRateLimit', 'KeySwapCost', 'AlphaHigh', 'AlphaLow', 'LiquidAlphaOn', 'Yuma3On', 'InitialColdkeySwapAnnouncementDelay', 'InitialColdkeySwapReannouncementDelay', 'InitialDissolveNetworkScheduleDuration', 'InitialTaoWeight', 'InitialEmaPriceHalvingPeriod', 'InitialStartCallDelay', 'KeySwapOnSubnetCost', 'HotkeySwapOnSubnetInterval', 'LeaseDividendsDistributionInterval', 'MaxImmuneUidsPercentage'];
        ...
        Registry: ['MaxAdditionalFields', 'InitialDeposit', 'FieldDeposit'];
        Commitments: ['MaxFields', 'InitialDeposit', 'FieldDeposit'];
        SafeMode: ['EnterDuration', 'ExtendDuration', 'EnterDepositAmount', 'ExtendDepositAmount', 'ReleaseDelay'];
        Drand: ['UnsignedPriority', 'HttpFetchTimeout'];
        Crowdloan: ['PalletId', 'MinimumDeposit', 'AbsoluteMinimumContribution', 'MinimumBlockDuration', 'MaximumBlockDuration', 'RefundContributorsLimit', 'MaxContributors'];
        Swap: ['ProtocolId', 'MaxFeeRate', 'MinimumLiquidity', 'MinimumReserve'];
        Contracts: ['Schedule', 'DepositPerByte', 'DefaultDepositLimit', 'DepositPerItem', 'CodeHashLockupDepositPercent', 'MaxCodeLen', 'MaxStorageKeyLen', 'MaxTransientStorageSize', 'MaxDelegateDependencies', 'UnsafeUnstableInterface', 'MaxDebugBufferLen', 'Environment', 'ApiVersion'];
    };
    viewFns: {
    ...
    apis: {
        ...
        NeuronInfoRuntimeApi: ['get_neurons', 'get_neuron', 'get_neurons_lite', 'get_neuron_lite'];
        SubnetInfoRuntimeApi: ['get_subnet_info', 'get_subnets_info', 'get_subnet_info_v2', 'get_subnets_info_v2', 'get_subnet_hyperparams', 'get_subnet_hyperparams_v2', 'get_all_dynamic_info', 'get_all_metagraphs', 'get_metagraph', 'get_all_mechagraphs', 'get_mechagraph', 'get_dynamic_info', 'get_subnet_state', 'get_selective_metagraph', 'get_coldkey_auto_stake_hotkey', 'get_selective_mechagraph', 'get_subnet_to_prune'];
        StakeInfoRuntimeApi: ['get_stake_info_for_coldkey', 'get_stake_info_for_coldkeys', 'get_stake_info_for_hotkey_coldkey_netuid', 'get_stake_fee'];
        ...
        SwapRuntimeApi: ['current_alpha_price', 'current_alpha_price_all', 'sim_swap_tao_for_alpha', 'sim_swap_alpha_for_tao'];
    };
};
export type BittensorWhitelistEntry = PalletKey | `query.${NestedKey<AllInteractions['storage']>}` | `tx.${NestedKey<AllInteractions['tx']>}` | `event.${NestedKey<AllInteractions['events']>}` | `error.${NestedKey<AllInteractions['errors']>}` | `const.${NestedKey<AllInteractions['constants']>}` | `view.${NestedKey<AllInteractions['viewFns']>}` | `api.${NestedKey<AllInteractions['apis']>}`;
type PalletKey = `*.${({
